...
The output `05_cutME_fq/*_cutME_L001_R*_001.fastq.gz` files will be used to generate ATAC fragment files ([3_ATAC_fragment](https://github.com/DiaoLab/scHiCAR/tree/dev/3_ATAC_fragment)) and chromatin contact pair files ([4_chromatin_contact](https://github.com/DiaoLab/scHiCAR/tree/dev/4_chromatin_contact)).
