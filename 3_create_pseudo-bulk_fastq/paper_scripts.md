### The following pipeline use astrocyte as an example cell type to show how we performed downstream analysis using pseudo-bulk FASTQ files in our [NBT paper](https://www.nature.com/articles/s41587-026-03013-7). 
